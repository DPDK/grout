...
%attr(644, root, root) %{_mandir}/man1/grcli-events.1*
%attr(644, root, root) %{_mandir}/man1/grcli-graph.1*
%attr(644, root, root) %{_mandir}/man1/grcli-interface.1*
%attr(644, root, root) %{_mandir}/man1/grcli-logging.1*
