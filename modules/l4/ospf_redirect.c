...
static void l4_redirect_register(void) {
	ip_input_local_add_proto(GR_IPPROTO_OSPF, "l4_redirect");
	ip6_input_local_add_proto(GR_IPPROTO_OSPF, "l4_redirect");
}

static struct rte_node_register l4_redirect_node = {
	.name = "l4_redirect",
...
static struct gr_node_info l4_redirect_info = {
	.node = &l4_redirect_node,
	.register_callback = l4_redirect_register,
};

GR_NODE_REGISTER(l4_redirect_info);
