...
#
# Dummy harness for a single ndr scenario. It emulates the external element
...
# forwarded.
#
# Usage: sudo ./ndr/harness/validate.sh <test> [builddir]
#
...
builddir="${2:-build}"
ndr_dir=$(dirname $here)

grcli_file="$ndr_dir/$test_name.grcli"
traffic_file="$ndr_dir/${test_name}.py"
