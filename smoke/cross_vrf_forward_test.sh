...
grcli add nexthop 172.16.1.2 iface $p1 id 2
grcli add ip route 16.1.0.0/16 via id 2 vrf 1

# from 16.0.1.1 to 16.0.0.1, two route lookup are done
grcli add vrf route 16.0.0.0/16 vrf 2 1
grcli show vrf route vrf 2
