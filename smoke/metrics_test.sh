...
interface add vlan v43 parent bond0 vlan_id 43 vrf gr-vrf2
...
nexthop add blackhole id 666 vrf gr-vrf1
nexthop add reject id 123456 vrf gr-vrf2
address add 10.0.0.1/24 iface v42
address add 10.1.0.1/24 iface v43
route add 0.0.0.0/0 via 10.0.0.2 vrf gr-vrf1
route add 4.5.21.2/27 via id 47 vrf gr-vrf1
route add 172.16.47.0/24 via id 1047 vrf gr-vrf2
interface add ipip tun0 local 10.0.0.1 remote 10.0.0.111 vrf gr-vrf1
address add 2345::1/24 iface v42
address add 2346::1/24 iface v43
route add ::/0 via 2345::2 vrf gr-vrf1
route add 2521:111::4/37 via id 1047 vrf gr-vrf1
route add 2521:112::/64 via id 45 vrf gr-vrf2
route add 2521:113::/64 via id 47 vrf gr-vrf1
EOF
