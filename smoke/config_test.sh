...
grcli add nexthop id 42 gw 1.2.3.4 iface p0
grcli add nexthop id 45 iface p0
grcli add nexthop id 47 gw 1.2.3.7 iface p0
grcli add nexthop id 1042 gw f00:ba4::1 iface p1
grcli add nexthop id 1047 gw f00:ba4::100 iface p1
grcli add nexthop id 42 gw f00:ba4::666 iface p1 # replace existing nexthop
grcli add nexthop gw ba4:f00::1 iface p0 mac ba:d0:ca:ca:00:02
grcli add nexthop gw 4.3.2.1 iface p1 mac ba:d0:ca:ca:00:01
