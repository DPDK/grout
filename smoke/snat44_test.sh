...
grcli add policy snat44 interface $p0 subnet 10.99.0.0/24 replace 172.16.0.1
grcli show policy snat44
grcli show policy conntrack
grcli set config conntrack max 1024 closed-timeout 2
