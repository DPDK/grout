...
# MPLS nexthop: swap to label 200, forward via n1
grcli nexthop add mpls iface p1 via 172.16.1.2 labels 200 id 42

# label route: incoming label 100 -> swap to 200
...
# n0 pushes MPLS(100) -> grout swaps to MPLS(200) -> n1 pops
