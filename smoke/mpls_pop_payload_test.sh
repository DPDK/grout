...
# MPLS nexthop: pop with explicit payload type
grcli nexthop add mpls iface p1 via 172.16.1.2 id 42 payload ipv4
...
# n0 pushes MPLS(100) -> grout pops using explicit payload type -> n1 receives plain IP
