...
int api_send(struct api_ctx *, uint32_t len, const void *payload);
...
#define STREAM_MORE 1 // item sent, buffer has room
#define STREAM_PAUSE 2 // item sent, buffer full (pause production)
#define STREAM_END 0 // no more items, stream done (success)
